...
<div id="main">
    ...
    <article class="post featured">
        ...
        <a href="{{ route('game.description', ['id' => $featured->id]) }}" class="image main">
            <img src="{{ asset('assets/images/' . $featured->image) }}" alt="{{ $featured->title }}" />
        </a>
    ...
    <!-- Posts -->
    <section class="posts">
        @foreach($secondaryFeatured as $game)
            <article>
                <header>
